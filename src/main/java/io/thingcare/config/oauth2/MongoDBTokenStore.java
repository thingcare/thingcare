package io.thingcare.config.oauth2;

import io.thingcare.domain.OAuth2AuthenticationAccessToken;
import io.thingcare.domain.OAuth2AuthenticationRefreshToken;
