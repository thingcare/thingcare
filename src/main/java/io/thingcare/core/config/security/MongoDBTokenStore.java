package io.thingcare.core.config.security;
...
import io.thingcare.modules.security.oauth.OAuth2AuthenticationAccessToken;
import io.thingcare.modules.security.oauth.OAuth2AuthenticationRefreshToken;
...
public class MongoDBTokenStore implements TokenStore {
	...
	public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
		OAuth2AuthenticationAccessToken token = oAuth2AccessTokenRepository.findByAuthenticationId(
